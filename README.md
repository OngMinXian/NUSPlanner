...
We constantly run the code on the deployment server and ensure that there are no errors before pushing the code onto GitHub. Branching is being used to implement new features and pull requests are issued each time a merge is initiated. 
