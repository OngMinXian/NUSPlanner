...
| ------------- | ------------- | ------------- | ------------- |
| Standardising layout of web page components across all screen sizes | https://github.com/OngMinXian/NUSPlanner/issues/3 | Solved | Consulted student advisor, solved by formatting page using react-bootstrap and flexbox instead of pure CSS |
